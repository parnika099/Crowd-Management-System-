...
# CrowdGuard Startup Script (uses uv for virtual environment)

echo "🛡️  CrowdGuard - Intelligent Crowd Management System"
echo "=================================================="
echo ""
...
# Check if MongoDB is running (use uv run so we use venv Python)
